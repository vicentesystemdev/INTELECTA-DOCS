...
<img
src="../06-evidencias/media-informe/media/image3.png"
style="width:0.2583in;height:0.15311in" />
...
<img
src="../06-evidencias/media-informe/media/image33.png"
style="width:3.71226in;height:1.98958in" />

<span id="_Toc228981644" class="anchor"></span>**ILUSTRACIÓN 1:**
...
<tr class="odd">
<td><p>Autor(es):</p>
<p>Quispe Mamani, J. y Flores Condori, M.</p></td>
<td><p><strong>Institución:</strong></p>
<p>Universidad Mayor de San Andrés (UMSA)</p></td>
...
<span id="_Toc228981629" class="anchor"></span>**TABLA 1:** SISTEMA DE
...
<tr class="odd">
<td><p>Autor(es):</p>
<p>Rojas Villarroel, P. y Gutiérrez Salinas, D.</p></td>
<td><p><strong>Institución:</strong></p>
<p>Universidad Franz Tamayo (UNIFRANZ)</p></td>
...
<span id="_Toc228981630" class="anchor"></span>**TABLA 2:** PLATAFORMA
...
<tr class="odd">
<td><p>Autor(es):</p>
<p>Romero, C. y Ventura, S.</p></td>
<td><p><strong>Institución:</strong></p>
<p>Universidad de Córdoba (Córdoba, España)</p></td>
<td><strong>Año:</strong> 2023</td>
</tr>
<tr class="even">
...
<span id="_Toc228981631" class="anchor"></span>**TABLA 3:** LEARNING
...
<tr class="odd">
<td><p>Autor(es):</p>
<p>Koivisto, M. y Nieminen, J.</p></td>
<td><p><strong>Institución:</strong></p>
<p>Universidad de Helsinki (Helsinki, Finlandia)</p></td>
<td><strong>Año:</strong> 2024</td>
</tr>
<tr class="even">
...
<span id="_Toc228981632" class="anchor"></span>**TABLA 4:** PREDICTIVE
...
<tr class="odd">
<td><p>Autor(es):</p>
<p>Ifenthaler, D. y Yau, J. Y.</p></td>
<td><p><strong>Institución:</strong></p>
<p>University of Mannheim (Mannheim, Alemania)</p></td>
<td><strong>Año:</strong> 2023</td>
</tr>
<tr class="even">
...
<span id="_Toc228981633" class="anchor"></span>**TABLA 5:** UTILIZING
...
# JUSTIFICACIÓN DEL PROYECTO<sup> </sup>
...
<span id="_Toc228981645" class="anchor"></span>**ILUSTRACIÓN 2:**
...
<span id="_Toc225185167" class="anchor"></span>Por lo tanto, la muestra
...
<span id="_Toc228981634" class="anchor"></span>**TABLA 6:**
...
<span id="_Toc228981635" class="anchor"></span>**TABLA 7:**
...
<span id="_Toc228981636" class="anchor"></span>**TABLA 8:** HISTORIAS DE
USUARIO
...
<span id="_Toc228981637" class="anchor"></span>**TABLA 9:** PRODUCT
BACKLOG
...
<span id="_Toc228981638" class="anchor"></span>**TABLA 10:** SPRINT
BACKLOG
...
<img
src="../06-evidencias/media-informe/media/image34.png"
style="width:7.24293in;height:5.04254in" />

<span id="_Toc228981646" class="anchor"></span>**ILUSTRACIÓN 3:**
...
**Diagrama de Caso de Uso: Sesiones**

> <img
> src="../06-evidencias/media-informe/media/image35.png"
> style="width:5.45041in;height:5.275in" />

<span id="_Toc228981647" class="anchor"></span>**ILUSTRACIÓN 4:**
DIAGRAMA DE CASO DE USO REGISTRO DE SESIONES
...
<td><blockquote>
<p>Docente, Estudiante, SuperAdmin y sistema</p>
</blockquote></td>
</tr>
<tr class="even">
<td><blockquote>
...
<td><blockquote>
<p>Registrar usuarios nuevos, Inicio de sesión, recuperación de
contraseña y edición de perfil</p>
</blockquote></td>
</tr>
<tr class="odd">
<td><blockquote>
...
<td><blockquote>
<p>La persona puede crear una cuenta para después iniciar sesión en caso
de pérdida de cuenta recuperar su contraseña además de que pueda editar
su perfil.</p>
</blockquote></td>
</tr>
</tbody>
...
<span id="_bookmark40" class="anchor"></span>**TABLA 11:** CASOS DE USO
REGISTRO DE SESIONES

**FUENTE:** ELABORACIÓN PROPIA

**Diagrama de Caso de Uso: Administración**

<img
src="../06-evidencias/media-informe/media/image36.png"
style="width:5.40243in;height:4.24691in" />

<span id="_Toc228981648" class="anchor"></span>**ILUSTRACIÓN 5:**
DIAGRAMA DE CASO DE USO ADMINISTRACIÓN
...
<td><blockquote>
<p>Estudiante, Docente, SuperAdmin y Sistema</p>
</blockquote></td>
</tr>
<tr class="even">
<td><blockquote>
...
<td><blockquote>
<p>Gestionar Usuarios, Configurar Categorías y Consultar Categorías.</p>
</blockquote></td>
</tr>
<tr class="odd">
<td><blockquote>
...
<td><blockquote>
<p>El administrador puede gestionar a los usuarios como dando de baja a
un usuario y cambiando el rol de los usuarios también la consulta de
categorías como también configuración de categorías</p>
<p>llevando a su modificación, alta de categorías y baja de
categorías.</p>
</blockquote></td>
</tr>
</tbody>
...
<span id="_Toc228981640" class="anchor"></span>**TABLA 12:** CASO DE USO
ADMINISTRACIÓN

**FUENTE:** ELABORACIÓN PROPIA

> **Diagrama de Caso de Uso: Modulo de Retos**

<img
src="../06-evidencias/media-informe/media/image37.png"
style="width:4.91667in;height:4.79893in" />

<span id="_Toc228981649" class="anchor"></span>**ILUSTRACIÓN 6:**
DIAGRAMA DE CASO DE USO MÓDULO DE RETOS
...
<td><blockquote>
<p>Resolver Retos y Configuración de los retos</p>
</blockquote></td>
</tr>
<tr class="odd">
<td><blockquote>
...
<td><blockquote>
<p>El estudiante tendrá la posibilidad de escoger la categoría del reto
seleccionar el reto asignado y enviar su solución. Para el sistema
evaluar el tiempo de la prueba asignada, retroalimentarse y guardar su
resultado. El administrador desarrollar la creación, edición y
eliminación del reto. El docente de validar la constancia del estudiante
y definir flag.</p>
</blockquote></td>
</tr>
</tbody>
...
<span id="_bookmark43" class="anchor"></span>**TABLA 13:** CASO DE USO
MODULO DE RETOS

**FUENTE:** ELABORACIÓN PROPIA

> **Diagrama de Caso de Uso: Modulo de Reportes**
>
> <img
> src="../06-evidencias/media-informe/media/image38.png"
> style="width:4.89434in;height:4.04064in" />

<span id="_Toc228981650" class="anchor"></span>**ILUSTRACIÓN 7:**
DIAGRAMA CASO DE USO MODULO DE REPORTES
...
<td><blockquote>
<p>Estudiante, Docente y Sistema</p>
</blockquote></td>
</tr>
<tr class="even">
<td><blockquote>
...
<td><blockquote>
<p>Validación de sesión, administración de reportes y exportación de
reporte</p>
</blockquote></td>
</tr>
<tr class="odd">
...
<td><blockquote>
<p>El sistema valida la sesión iniciada tanto docente como estudiante
inician su modulo el sistema genera un reporte dando un historial de
pruebas visualizando el progreso y el sistema dando filtro
calculando</p>
<p>métricas para visualizar los detalles colocar un comentario y
exportar un reporte PDF.</p>
</blockquote></td>
</tr>
</tbody>
</table>

<span id="_bookmark44" class="anchor"></span>**TABLA 14:** CASO DE USO
MÓDULO DE REPORTES

**FUENTE:** ELABORACIÓN PROPIA

**Diagrama de Caso de Uso: Modulo de Seguridad**

<img
src="../06-evidencias/media-informe/media/image39.png"
style="width:4.89583in;height:4.26087in" />

<span id="_Toc228981651" class="anchor"></span>**ILUSTRACIÓN 8:**
DIAGRAMA DE CASO DE USO MODULO DE SEGURIDAD
...
<td><blockquote>
<p>Estudiante, Administrador, y Sistema</p>
</blockquote></td>
</tr>
<tr class="even">
<td><blockquote>
...
<td><blockquote>
<p>Realizar y restaurar copias de seguridad</p>
</blockquote></td>
</tr>
<tr class="odd">
<td><blockquote>
...
<td><blockquote>
<p>El sistema ayuda al registro de logs del sistema, realizar copias de
seguridad y generación de retos mientras el estudiante y
administrador</p>
<p>pueda navegar normalmente.</p>
</blockquote></td>
</tr>
</tbody>
</table>

<span id="_Toc228981643" class="anchor"></span>**TABLA 15:** CASO DE USO
MÓDULO DE SEGURIDAD
...
<img
src="../06-evidencias/media-informe/media/image40.png"
style="width:5.51806in;height:4.49236in" />

<span id="_Toc228981652" class="anchor"></span>**ILUSTRACIÓN 9:**
DIAGRAMA DE SECUENCIA INICIO DE SESIÓN

**FUENTE:** ELABORACIÓN PROPIA

<img
src="../06-evidencias/media-informe/media/image41.png"
style="width:5.82917in;height:4.46903in" />

<span id="_Toc228981653" class="anchor"></span>**ILUSTRACIÓN 10:**
DIAGRAMA DE SECUENCIA MÓDULO DE RETOS

**FUENTE:** ELABORACIÓN PROPIA

<img
src="../06-evidencias/media-informe/media/image42.png"
style="width:5.62917in;height:4.96665in" />

<span id="_Toc228981654" class="anchor"></span>**ILUSTRACIÓN 11:**
DIAGRAMA DE SECUENCIA MÓDULO DE REPORTES

**FUENTE:** ELABORACIÓN PROPIA

<img
src="../06-evidencias/media-informe/media/image43.jpg"
style="width:5.88542in;height:3.32545in" />

<span id="_Toc228981655" class="anchor"></span>**ILUSTRACIÓN 12:**
DIAGRAMA DE SECUENCIA MÓDULO DE ADMINISTRACIÓN

**FUENTE:** ELABORACIÓN PROPIA

<img
src="../06-evidencias/media-informe/media/image44.png"
style="width:5.74028in;height:3.97361in" />

<span id="_Toc228981656" class="anchor"></span>**ILUSTRACIÓN 13:**
DIAGRAMA DE SECUENCIA MÓDULO DE EVALUACIÓN
...
<img
src="../06-evidencias/media-informe/media/image45.png"
style="width:5.74074in;height:4.09385in" />

<span id="_Toc228981657" class="anchor"></span>**ILUSTRACIÓN 14:**
DIAGRAMA DE COLABORACIÓN DOCENTE

**FUENTE:** ELABORACIÓN PROPIA

<img
src="../06-evidencias/media-informe/media/image46.png"
style="width:5.81458in;height:3.44306in" />

<span id="_Toc228981658" class="anchor"></span>**ILUSTRACIÓN 15:**
DIAGRAMA DE COLABORACIÓN ADMINISTRADOR

**FUENTE:** ELABORACIÓN PROPIA

<img
src="../06-evidencias/media-informe/media/image47.png"
style="width:6.12917in;height:3.29306in" />

<span id="_Toc228981659" class="anchor"></span>**ILUSTRACIÓN 16:**
DIAGRAMA DE COLABORACIÓN ESTUDIANTE

**FUENTE:** ELABORACIÓN PROPIA

#### <img
src="../06-evidencias/media-informe/media/image48.png"
style="width:4.97292in;height:6.57917in" />DIAGRAMAS DE CLASES DE ALTO NIVEL

<span id="_Toc228981660" class="anchor"></span>

**ILUSTRACIÓN 17:** DIAGRAMA DE CLASE DE ALTO NIVEL

**FUENTE:** ELABORACIÓN PROPIA

#### DIAGRAMAS DE CLASES DE BAJO NIVEL

<img
src="../06-evidencias/media-informe/media/image49.png"
style="width:6.61458in;height:4.96094in" />

<span id="_Toc228981661" class="anchor"></span>**ILUSTRACIÓN 18:**
DIAGRAMA DE CLASE DE BAJO NIVEL
...
<img
src="../06-evidencias/media-informe/media/image50.png"
style="width:7.48958in;height:5.32842in" />

<span id="_Toc228981662" class="anchor"></span>**ILUSTRACIÓN 19:**
DIAGRAMA FÍSICO
...
<img
src="../06-evidencias/media-informe/media/image51.png"
style="width:8.6625in;height:4.87266in" />

<span id="_Toc228981663" class="anchor"></span>**ILUSTRACIÓN 20:** MAPA
NAVEGACIONAL
...
- Ifenthaler, D., & Yau, J. Y. (2023). Utilizing learning analytics to
  support study success. Springer.

- OECD. (2023). PISA 2022 results: The state of learning and equity in
...
- Romero, C., & Ventura, S. (2020). Educational data mining and learning
  ...
  Mining and Knowledge Discovery, 10(3), e1355.

- Siemens, G. (2022). Learning analytics: The emergence of a discipline.
  American Behavioral Scientist, 66(5), 685–698.

- Baker, R., & Inventado, P. (2021). Educational data mining and
  learning analytics. In Learning analytics: From research to practice.
  Springer.

- Ifenthaler, D. (2021). Learning analytics in higher education.
  Educational Technology & Society, 24(3), 1–10.

- Hernández Sampieri, R., Fernández Collado, C., & Baptista, M. (2022).
  Metodología de la investigación (7.ª ed.). McGraw-Hill Education.

- Creswell, J. W., & Creswell, J. D. (2021). Research design:
  Qualitative, quantitative, and mixed methods approaches (5th ed.).
  SAGE Publications.

- UNESCO. (2022). Transforming education through digital technologies.
  UNESCO Publishing.

- Ministerio de Educación. (2023). Modelo educativo sociocomunitario
  productivo. Estado Plurinacional de Bolivia.
...
Destinatario: Docentes del área de matemáticas del Colegio San Antonio
de Padua

### **A.1.** Preguntas

1.  ¿Cómo evalúa actualmente el desempeño matemático de los estudiantes?

2.  ¿Qué tipo de resultados obtiene normalmente en evaluaciones de
    razonamiento lógico?

3.  ¿Se identifican diferencias en el rendimiento según temas
    matemáticos?

4.  ¿Qué dificultades observa en los estudiantes al resolver problemas
    matemáticos?

5.  ¿Cómo se registran los resultados de las evaluaciones académicas?

6.  ¿La información obtenida permite analizar el desempeño más allá de
    la calificación?

7.  ¿Es posible comparar el rendimiento de los estudiantes a lo largo
    del tiempo?

8.  ¿Qué tan frecuente es que los estudiantes cometan errores en
    problemas de análisis y razonamiento?

9.  ¿Cómo se identifican los contenidos donde los estudiantes presentan
    más errores?

10. ¿Considera que los resultados actuales permiten comprender el
    comportamiento del aprendizaje matemático?

### A.2. Resultados

1.  Las evaluaciones se basan principalmente en exámenes escritos con
    calificación numérica.

2.  Se reportan bajos porcentajes de aciertos en ejercicios de
    razonamiento lógico.

3.  Se observan diferencias de rendimiento entre distintos contenidos
    matemáticos.

4.  Los estudiantes presentan errores frecuentes en la resolución de
    problemas.

5.  Los resultados se registran en notas generales sin mayor detalle.

6.  La información no permite analizar patrones de desempeño o tipos de
    error.

7.  No se realiza comparación sistemática del rendimiento en distintos
    periodos.

8.  Se evidencian errores recurrentes en ejercicios que requieren
    análisis.

9.  La identificación de temas con mayor dificultad se realiza de forma
    general.

10. La información disponible no permite comprender completamente el
    proceso de aprendizaje.

### A.3. Interpretación de la entrevista

Los resultados evidencian bajo rendimiento en razonamiento lógico,
registros académicos centrados en calificaciones generales y
dificultades para identificar patrones de desempeño, lo cual respalda
directamente la problemática planteada.

## ANEXO B. ENCUESTA 

Destinatario: Estudiantes de 5to y 6to de secundaria
...
1.  ¿Obtienes resultados satisfactorios en evaluaciones de matemáticas?

2.  ¿Resuelves correctamente problemas que requieren razonamiento
    lógico?

3.  ¿Cometes errores frecuentes en ejercicios matemáticos?

4.  ¿Te resulta fácil identificar en qué temas tienes más dificultades?

5.  ¿Tus evaluaciones muestran en qué tipo de problemas fallas?

6.  ¿Puedes observar tu progreso en matemáticas a lo largo del tiempo?

7.  ¿Las evaluaciones reflejan cómo resuelves los ejercicios paso a
    paso?

8.  ¿Tienes dificultades en problemas que requieren análisis o
    interpretación?

9.  ¿Consideras que entiendes los errores que cometes en matemáticas?

10. ¿Las evaluaciones te ayudan a mejorar tu desempeño en matemáticas??

### B.2. Resultados del Cuestionario

1.  Entre el 60% y 70% de los estudiantes reporta resultados no
    satisfactorios en matemáticas.

2.  Aproximadamente el 65% indica dificultades en ejercicios de
    razonamiento lógico.

3.  Más del 70% reconoce cometer errores frecuentes en ejercicios
    matemáticos.

4.  Cerca del 60% señala que no identifica claramente sus dificultades
    por tema.

5.  Un 68% indica que las evaluaciones no muestran en qué tipo de
    problemas fallan.

6.  Alrededor del 65% indica que no puede visualizar su progreso en el
    tiempo.

7.  Más del 70% afirma que las evaluaciones no reflejan el proceso de
    resolución.

8.  Un 72% presenta dificultades en problemas de análisis e
    interpretación.

9.  Aproximadamente el 60% no logra comprender sus errores con claridad.

10. Más del 65% considera que las evaluaciones no contribuyen
    significativamente a mejorar su desempeño.

<span id="_Toc225181107" class="anchor"></span>**B.3.Interpretación  
**Los resultados cuantitativos evidencian bajo rendimiento en resolución
de problemas, dificultades en razonamiento lógico, falta de claridad en
errores cometidos y limitaciones en la comprensión del desempeño
académico, lo cual respalda la problemática planteada.

## ANEXO C. OBSERVACIÓN

- **Tipo:** Observación no participante

- **Escala:** Alto – Medio – Bajo

### C.1. Indicadores observables

1.  Porcentaje de aciertos en evaluaciones matemáticas

2.  Registro de resultados por contenido matemático

3.  Organización de resultados académicos

4.  Existencia de información detallada sobre errores

5.  Registro del proceso de resolución de ejercicios

6.  Comparación de resultados entre evaluaciones

7.  Identificación de contenidos con mayor dificultad

8.  Comportamiento del estudiante durante la resolución de problemas

9.  Tiempo empleado en resolver ejercicios

10. Frecuencia de errores en problemas de razonamiento

11. Uso de información previa para evaluar desempeño

12. Evidencia de evolución del rendimiento académico

## C.2. Resultados simulados de la observación

**Indicador 1: Porcentaje de aciertos → Bajo**

Se observa bajo nivel de respuestas correctas en ejercicios de
razonamiento.

**Indicador 2: Registro por contenido → Bajo**

No se diferencian resultados por temas específicos.

**Indicador 3: Organización de resultados → Medio**

Existe registro, pero en formato general.

**Indicador 4: Detalle de errores → Bajo**

No se registran tipos de error cometidos.

**Indicador 5: Proceso de resolución → Bajo**

No se almacena información del procedimiento del estudiante.

**Indicador 6: Comparación de resultados → Bajo**

No se realiza análisis entre evaluaciones.

**Indicador 7: Identificación de dificultades → Medio-Bajo**

Se realiza de forma general, no específica.

**Indicador 8: Comportamiento en resolución → Medio**

Se observan dificultades en problemas complejos.

**Indicador 9: Tiempo de resolución → Medio**

No se registra formalmente.

**Indicador 10: Errores en razonamiento → Alto**

Se evidencian errores frecuentes.

**Indicador 11: Uso de información previa → Bajo**

No se utilizan datos históricos.

**Indicador 12: Evolución del rendimiento → Bajo**

No se observa seguimiento estructurado.

## C.3. Interpretación de la observación

La observación evidencia bajo desempeño en razonamiento lógico,
registros académicos generales, escasa diferenciación por contenidos y
ausencia de análisis del proceso de resolución, lo cual respalda
directamente la problemática identificada en la investigación.
